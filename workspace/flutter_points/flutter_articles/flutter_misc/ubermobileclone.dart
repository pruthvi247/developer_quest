...
class _EmbedWhatsAppState extends State<EmbedWhatsApp> {
  ...
  void loadIFrame() {
    ...
    _iFrameElement.src = 'https://codepen.io/mkiisoft/debug/wvKyydP';
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      child: Stack(
        fit: StackFit.expand,
        children: [
          ClipPath(clipper: CrossPath(), child: Container(color: Color(0xFF000000))),
          Column(
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Image.network('${baseUrl}flutter-yeti.appspot.com/o/oneplus.png?alt=media'),
                    ],
                  ),
                ),
              ),
