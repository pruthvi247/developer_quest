_Keep It Simple, Keep It Flutter_
...
The design pattern taken up by the Flutter framework is like the MVC design pattern, but more like the [PAC](https://softwareengineering.stackexchange.com/questions/207620/what-are-the-downfalls-of-mvc#answer-207672) ([Presentation-Abstraction-Control](http://en.wikipedia.org/wiki/Presentation%E2%80%93abstraction%E2%80%93control)) design pattern. Flutter’s emphasis is more on the Interface (Presentation), a little on the logic and event handling (Controller), and less on data (Model). In Flutter, data is an Abstraction. It can be anything; It can be nothing. It’s implementation is left to the developer.
...
[_site:flutter.dev insubject:”controller”_](https://www.google.com/search?q=site%3Aflutter.dev+insubject%3A%22controller%22)
...
https://github.com/Andrious/flutter_weather?source=post_page-----1b7c415eb487--------------------------------
...
[settingspage-1](https://github.com/felangel/bloc/blob/f951eef84e4e740697b712ff3e1cf244eea3a1e6/examples/flutter_weather/lib/settings/view/settings_page.dart#L15)
[settingspage-2](https://github.com/Andrious/flutter_weather/blob/29b0e2b7649ca000e09e1807026867d0697b260c/lib/main/view/settings/settings_page.dart#L24)
![[Pasted image 20250130115540.png]] ![[Pasted image 20250130115547.png]]
# Inherited Builds
...
In the second screenshot below, the _StateX_ version utilizes an InheritedWidget as well. However, the widget, _WeatherAppView_, is replaced by the State object, __WeatherAppState,_ that defines the overall ‘look and behavior’ of the app.
...
[app.dart](https://github.com/felangel/bloc/blob/f951eef84e4e740697b712ff3e1cf244eea3a1e6/examples/flutter_weather/lib/app.dart#L8)
[weather-app.dart](https://github.com/Andrious/flutter_weather/blob/29b0e2b7649ca000e09e1807026867d0697b260c/lib/app/view/weather_app.dart#L11)
...
[app.dart](https://github.com/felangel/bloc/blob/f951eef84e4e740697b712ff3e1cf244eea3a1e6/examples/flutter_weather/lib/app.dart#L22)
[weather_controller.dart](https://github.com/Andrious/flutter_weather/blob/29b0e2b7649ca000e09e1807026867d0697b260c/lib/main/controller/weather_controller.dart#L115)
[weather_controller.dart](https://github.com/Andrious/flutter_weather/blob/29b0e2b7649ca000e09e1807026867d0697b260c/lib/main/controller/weather_controller.dart#L136)
